...
VALUES			
					(	"Nguyen Thi Ngoc",   '1998-09-01',	"Female",	8,		7,		"RK01",			 20,			"ngocnguyen"),
					(	"Nguyen Le Minh",	 '1999-12-16',	"Male",		20,		18,		"RK01",			 40,			"minhle"),
					(	"Nguyen Van Anh",	 '1997-11-23',	"Female",	9,		9,		"RK02",			 30,			"vananh"),
					(	"Nguyen Khanh Huyen",'1998-10-24',	"Female",	10,		10,		"RK01",			 35,			"khanhngoc"),
...
SELECT		MONTH(Birth_Date) AS MONTH, COUNT(TraineeID) AS COUT,JSON_ARRAYAGG(Full_Name) AS Name 
FROM		trainee
...
FROM 	trainee
WHERE	TraineeID = 3;
SELECT  *	FROM	trainee; -- show ket qua
-- update
UPDATE  trainee
SET 
		Training_Class = "RK02"
